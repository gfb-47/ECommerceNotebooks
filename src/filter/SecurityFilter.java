...
//		return;
		...
		if (endereco.equals("/ECommerceNotebooks/faces/login.xhtml")||
			(endereco.equals("/ECommerceNotebooks/faces/usuario.xhtml"))) {
			chain.doFilter(request, response);
			return;
		}
		...
		if (usuario == null) {
			((HttpServletResponse) response).sendRedirect("/ECommerceNotebooks/faces/login.xhtml");
		}  else {
